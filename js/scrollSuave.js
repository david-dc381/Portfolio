(function () {
  ...
  let propiedadesScroll = {
    ...
    volverArriba:     document.getElementsByClassName("volver-arriva"),
    destino:          null,
  ...
  let metodosScroll = {
    ...
    moverse: function (e) {
      ...
      propiedadesScroll.seccionDistancia =
        document.querySelector(propiedadesScroll.destino).offsetTop - 115;
    ...
    subir: function (e) {
      ...
      propiedadesScroll.intervalo = setInterval(function () {
        // si la posicion es mayor a cero retorcedemos
        if (propiedadesScroll.posicionActual > 0) {
          ...
          // si no es mayor a 0, de igual manera detenemos la ejecución
          return;
        }
        window.scroll(0, propiedadesScroll.posicionActual);
      }, 15);
